...
public class ModUsagePacket {
    ...
    public static void send(LoginPacketSender sender) {
    ...
    public static CompletableFuture<@Nullable FriendlyByteBuf> receive(
            Minecraft client, ClientHandshakePacketListenerImpl handler, FriendlyByteBuf buf, Consumer<PacketSendListener> callbacksConsumer
    ) {
